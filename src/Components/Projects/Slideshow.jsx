  ...
  return (
    <section id="Projects" className="projects--section">
      <div className='projects--content'>
            ...
            <div className={`card ${value === 1 ? 'back1' : value === 2 ? 'center1' : value === 3 ? 'center2' : 'back2'}`} onClick={handleCardClick}>
              ...
              <div className={`card ${value === 2 ? 'back1' : value === 3 ? 'center1' : value === 4 ? 'center2' : 'back2'}`} onClick={handleCardClick}>
              <h1>Bank App</h1>
             ...
             <div className={`card ${value === 3 ? 'back1' : value === 4 ? 'center1' : value === 1 ? 'center2' : 'back2'}`} onClick={handleCardClick}>
             ...
             <div className={`card ${value === 4 ? 'back1' : value === 1 ? 'center1' : value === 2 ? 'center2' : 'back2'}`} onClick={handleCardClick}>
             <h1>Chat App</h1>
